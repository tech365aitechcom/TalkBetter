    ...
    >
      <div className='p-6 size-full bg-zinc-800 text-white rounded-lg shadow-md dark:bg-zinc-900'>
        <div className='flex items-center justify-between mb-4'>
          ...
          <button className='p-2 bg-zinc-700 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-800 dark:hover:bg-zinc-700 cursor-pointer'>
            <svg
              xmlns='http://www.w3.org/2000/svg'
              width='32'
              height='32'
